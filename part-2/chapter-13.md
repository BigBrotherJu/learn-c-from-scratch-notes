...
- <span class="thoughts">1's complement 是怎么想出来的</span>
  ...
  - 取值范围
    ...
    我们限定二进制数是 8 位的，那么 -1 在新的表示法下就是 `1111 1110`，-0 就是 `1111 1111`。-127 是 `1000 0000`，+127 是 `0111 1111`，而 -128 是 `0111 1111`，+128 是 `1000 0000`。可以看到，产生了重复。所以 8 位二进制数用这种表示法取值范围是 -127～+127，而且 0 有两种表示方法。
